...
export const getBunnyFactoryContract = (signer?: Signer | Provider, chainId?: number) => {
  return getContract({ abi: bunnyFactoryAbi, address: getBunnyFactoryAddress(chainId), signer }) as BunnyFactory
}
