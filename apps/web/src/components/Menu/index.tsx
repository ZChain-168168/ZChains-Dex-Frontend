...
const Menu = (props) => {
  ...
  const mtvPriceUsd = useCakeBusdPrice({ forceMainnet: true })
  ...
  return (
    <>
      <UikitMenu
        ...
        rightSide={
          <>
            <GlobalSettings color="primary" mode={SettingsMode.GLOBAL} />
            <NetworkSwitcher />
            <UserMenu />
          </>
        }
        ...
        langs={languageList}
        setLang={setLanguage}
        cakePriceUsd={mtvPriceUsd}
        links={menuItems}
        // subLinks={activeMenuItem?.hideSubNav || activeSubMenuItem?.hideSubNav ? [] : activeMenuItem?.items}
        footerLinks={getFooterLinks}
        activeItem={activeMenuItem?.href}
        activeSubItem={activeSubMenuItem?.href}
        buyCakeLabel={t('Buy MTN')}
