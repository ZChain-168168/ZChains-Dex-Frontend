...
export const DOCS_URL = 'https://docs.metaviralscan.com'
export const EXCHANGE_DOCS_URLS = `${DOCS_URL}/products/pancakeswap-exchange`
export const EXCHANGE_HELP_URLS = `${DOCS_URL}/help`
