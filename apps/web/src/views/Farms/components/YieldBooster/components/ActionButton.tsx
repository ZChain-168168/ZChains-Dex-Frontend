...
const BoosterTooltip = () => {
  ...
  return (
    <>
      {t(`Boost multiplier is calculated based on the staking conditions from both Farms and fixed-term ${cstValue.tokenName} syrup pool and will be automatically updated upon user actions.`)}
      <LinkExternal
        href={`${DOCS_URL}/products/yield-farming/bcake/faq#how-are-the-bcake-multipliers-calculated`}
        external
      >
        {t('Learn More')}
      </LinkExternal>
