...
import { Currency, Percent, WNATIVE, ChainId, ROUTER_ADDRESS } from '@pancakeswap/sdk'
import {
  Button,
  Text,
  AddIcon,
...
const zapSupportedChainId = [ChainId.ZCD, ChainId.ZCD_TESTNET]
...
export default function RemoveLiquidity({ currencyA, currencyB, currencyIdA, currencyIdB }) {
  ...
  async function onAttemptToApprove() {
    ...
    const domain = {
      name: 'TeleportSwap LPs', // 'Pancake LPs', // edit
      version: '1',
      chainId,
