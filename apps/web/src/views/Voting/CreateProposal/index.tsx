...
import { client, ADMINS, PANCAKE_SPACE, VOTE_THRESHOLD } from '../config'
              ...
              <CardBody>
                ...
                {account && (
                  <Flex alignItems="center" mb="8px">
                    ...
                    <LinkExternal isBscScan href={getBlockExploreLink(account, 'address', chainId)}>
                ...
                <Flex alignItems="center" mb="16px">
                  ...
                  <LinkExternal isBscScan href={getBlockExploreLink(snapshot, 'block', chainId)}>
                    {snapshot}
                  </LinkExternal>
                </Flex>
                {account ? (
