  ...
  return (
    <>
      <Flex px="24px" pt="24px" flexDirection="column">
        ...
        <Flex alignItems="center">
          ...
          <Button
            ...
            external
            variant="text"
            href="/?inputCurrency=BNB&outputCurrency=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c"
          >
            {t('Convert')}
          </Button>
        </Flex>
      ...
      <Flex px="24px" pb="24px" flexDirection="column">
        ...
        <Button as={Link} external style={{ width: '100%' }} href="/?outputCurrency=BNB" variant="secondary">
